...
// Services - Implemented as a clean 2x2 grid as per the target design
  ...
  return (
    <section id="services" className={styles.section}>
      ...
      <div className={styles.servicesGrid}>
        {services.map((item, i) => (
          <div key={i} className={styles.serviceCard}>
            ...
            <h3 className="text-xl font-extrabold text-[#5850ec] mb-4">{item.title}</h3>
      ...
      <div className="mt-12 text-center">
        <Link href="#services" className="inline-flex items-center gap-2 text-[#5850ec] font-bold hover:gap-4 transition-all">
